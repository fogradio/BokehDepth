...
class BaseDataset(Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.validate_intrinsics = kwargs.pop("validate_intrinsics", False)
        super().__init__()
        assert normalize in [None, "imagenet", "openai"]

        self.split_file = split_file
        self.test_mode = test_mode
        # Prefer the supplied data_root; otherwise read from env vars; finally default to "datasets".
        self.data_root = data_root if data_root is not None else os.environ.get("DATAROOT", "datasets")
        ...
        self.filler.test_mode = test_mode  # forward test_mode to RandomFiller
